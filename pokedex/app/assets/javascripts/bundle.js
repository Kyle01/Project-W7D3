...
/***/ "./frontend/reducers/entity_reducer.js":
/*!*********************************************!*\
  !*** ./frontend/reducers/entity_reducer.js ***!
  \*********************************************/
/*! no static exports found */
...
var pokemonReducer = function pokemonReducer() {
  ...
  switch (action.type) {
    case _pokemon_actions.RECEIVE_ALL_POKEMON:
      return (0, _merge2.default)(nextState, state, action.pokemon);
    default:
      return state;
  }
};
...
var _entity_reducer = __webpack_require__(/*! ./entity_reducer */ "./frontend/reducers/entity_reducer.js");

var _entity_reducer2 = _interopRequireDefault(_entity_reducer);
